...
const Shop = () => {
  ...
  // Fetching categories and products with custom hooks
  ...
  // Setting categories when the categories query is loaded
  useEffect(() => {
  ...
  // Filtering and setting products based on filters
  useEffect(() => {
  ...
  // Handle click on brand radio buttons
